...
const DashDetails = () => {
    ...
    const url = 'https://rsruh-pow-pow-server.vercel.app/users';
    ...
    const url2 = 'https://rsruh-pow-pow-server.vercel.app/dashfood';
    ...
    return (
        <main className="space-y-6 m-2">
            <div className="flex flex-col space-y-6 md:space-y-0 md:flex-row justify-between">
                <div className="mr-6">
                    <h1 className="text-4xl text-black font-semibold mb-2">Dashboard</h1>
                    <h2 className="text-gray-600 ml-0.5">Pow Pow BD</h2>
                </div>
            ...
            <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
                ...
                <div className="row-span-3 bg-white shadow rounded-lg h-[550px]">
                    ...
                    <div className="overflow-y-auto">
                        <ul className="p-6 space-y-6">
                            {users?.map(user => <li key={user?._id} className="flex items-center">
                ...
                <div className="flex flex-col row-span-3 bg-white shadow rounded-lg h-[550px]">
                    <div className="px-6 py-5 font-semibold border-b border-gray-100">Students by type of studying</div>
                    <div className="overflow-y-auto">
                        <ul className="p-6 space-y-6">
                            {foods?.map(food => <li key={food?._id} className="flex items-center">
                                <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                                    <img src={food?.foodPic} alt='' />
                                </div>
                                <span className="text-gray-600">{food?.foodName.slice(0, 20)}</span>
                                <span className="ml-auto font-semibold">{food?.quantity} Pis</span>
                            </li>)
            ...
            <section className="text-right font-semibold text-gray-500">
                <p href="#" className="text-purple-600 hover:underline">This Website Made</p> with <a href="https://tailwindcss.com/" className="text-teal-400 hover:underline">Tailwind CSS</a> by Md. Ruhul Amin
            </section>
        </main>
    );
};
