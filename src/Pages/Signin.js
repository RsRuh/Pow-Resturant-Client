...
const Signin = () => {
    ...
    return (
        <div
            className="py-5 flex flex-col items-center justify-center min-h-screen bg-secondary"> <div className="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-3xl w-50 max-w-md">
